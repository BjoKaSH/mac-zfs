...
extra_args_help_short=" [ --run_fstest 1/0 ]  [ --fstest_suite path-to-fstest-script ] "
extra_args_help_long="   --run_fstest 1/0   run the fstest suite if set to 1\n   --fstest_suite path  path to script that executes fstest in the current directory"
extra_args="--run_fstest:has_fstest --fstest_suite:fstest_suite"
